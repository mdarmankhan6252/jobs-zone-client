...
const Nav = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0  shadow-xs z-500 bg-gray-100/80 backdrop-blur-3xl transition-transform duration-500 ease-in-out ${showNav ? 'translate-y-0' : '-translate-y-full'}`}>
