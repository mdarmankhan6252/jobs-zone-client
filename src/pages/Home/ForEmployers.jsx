  ...
  return (
    <div className="bg-gray-50">
      <div className=" max-w-7xl mx-auto px-4 py-16  md:pt-24 md:px-8 ">
        ...
        {/* Card section */}
        <div className=" grid grid-cols-1 gap-6 snap-normal overflow-x-auto bg-gray-50 pb-16 sm:px-4 md:-mx-8 md:flex md:px-8 md:pb-24 xl:place-content-center md:gap-8">
          <Link to={"/"}>
