  ...
  return (
    <div className="bg-gray-50">
      <div className=" max-w-7xl mx-auto flex  items-center px-4 py-8  md:justify-between md:px-8 ">
        ...
        <div>
          <a
            className="gap-x-2 font-medium items-center justify-center rounded-lg transition-colors focus:ring-4 focus:outline-none h-max border border-transparent bg-violet-700 text-white hover:bg-violet-800 disabled:bg-violet-200 focus:ring-violet-100 text-[16px] px-4 py-2.5 hidden md:inline md:min-w-max"
            href="/"
          >
            Our pledge
          </a>
