    ...
    <div>
      <div className="border-b border-gray-200">
        ...
        <div className="my-8 flex flex-col items-center rounded-xl border border-gray-200 p-8 shadow-xs md:my-12">
          ...
          <h3 className="mb-2 max-w-[360px] text-center text-xl font-medium text-gray-900">
            We don&apos;t have any data on what Jobs Zone pays its remote employees
          </h3>
          <p className="mb-8 max-w-[360px] text-center text-gray-600">If you work at Jobs Zone, claim your profile and post a job to add data.</p>
          <Link
