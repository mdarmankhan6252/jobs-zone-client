        ...
        <div className="flex flex-col w-full">
          <div className="mb-6 flex w-full flex-col xl:mb-12">
            <div className="flex  flex-col gap-y-3 xl:flex-row xl:gap-x-[3px]">
              <div className="bg-[#FFFFFF] flex w-full flex-row gap-x-2 py-3 xl:py-4 items-center relative overflow-visible pl-[42px] pr-[14px] xl:rounded-none outline-hidden rounded-lg xl:border-none focus-within:border-violet-400 xl:focus-within:border-none  focus-within:ring-4 xl:focus-within:ring-0 focus-within:ring-violet-100  ">
                <LuSearch className="w-7 h-7 "></LuSearch>
                <span className="w-full flex justify-between items-center">
                  <input
                    type="text"
                    className="w-full outline-hidden text-xl"
              ...
              <div className="mt-1 flex h-min gap-x-3 items-center xl:mt-0 xl:bg-white xl:px-4  py-3 xl:py-4">
                ...
                <button className="inline-flex gap-x-2  font-medium items-center justify-center rounded-lg transition-colors focus:ring-4 focus:outline-hidden h-max border border-transparent bg-violet-700 text-white hover:bg-violet-800 disabled:bg-violet-200 focus:ring-red-100 text-[16px] py-3 px-5 w-full ">
                  Search
                </button>
              </div>
            </div>
            ...
            <div className="mt-[1px] hidden gap-x-4 xl:gap-x-8 bg-white px-8 py-4 xl:flex xl:pr-28">
                <button className="flex w-full gag-x-2 font-medium items-center rounded-lg transition-colors focus:ring-4 focus:outline-hidden h-max disabled:text-gray-300 disabled:border-gray-100 border border-gray-200 shadow-2xs hover:bg-gray-50 hover:text-gray-800 bg-white text-gray-700 focus:ring-gray-100 text-[16px] px-4 py-2 justify-between ">
